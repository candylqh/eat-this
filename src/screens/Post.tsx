...
export function Post() {
  const { state, currentResult, sayWent, sayMissed, pickChip, filePost, restart } = useApp();
    ...
    <div className="screen" style={{ overflow: 'hidden' }}>
      <div className="screen-scroll">
        <div className="eyebrow">
          {formatClock(currentResult.backAt)} · {currentResult.stall.centreName} {currentResult.stall.unit}
        </div>
